...
const Item = ({ index, backgroundColor, title, text, link, activeLanguage, image, slideMaxHeightPercent }: IItem) => {
  ...
  return (
    <View key={index} style={[styles.slide, { backgroundColor }]}>
      ...
      >
        ...
        <View>
          <Text style={styles.text}>{Array.isArray(text) ? text[language] : text}</Text>
          {link && (
