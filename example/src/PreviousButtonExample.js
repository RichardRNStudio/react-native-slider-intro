...
import { faArrowCircleRight, faCheckCircle, faArrowCircleLeft } from '@fortawesome/free-solid-svg-icons'
...
const renderNextButton = () => {
  return <FontAwesomeIcon icon={faArrowCircleRight} color={'white'} size={35} />
}
...
const PreviousButtonExample = ({ closeExample }) => {
  return (
    <SliderIntro
